...
This harness is opt-in and is useful when a change may affect event-replacement performance or emitted size. It is not part of the normal repository gate.
