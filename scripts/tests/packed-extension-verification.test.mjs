	...
	try {
		...
		await writeModule(
			...
			[
				...
				"\treadonly onEventOverflowDefault?: (context: CalendarEventOverflowDefaultContext<TMetadata>) => void;",
				"}",
				"export interface CalendarEventOverflowDefaultContext<TMetadata> {",
				"\treadonly events: readonly CalendarEventInput<TMetadata>[];",
