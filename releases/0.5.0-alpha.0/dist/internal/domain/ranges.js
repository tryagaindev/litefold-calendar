import { assertCalendarDate, compareCalendarDates, getDaysInMonth } from "./civil-date.js";
/** Tests a supported civil date against independently optional inclusive bounds. */
export function isCalendarDateWithinBounds(date, minDate, maxDate) {
...
export function doesCalendarMonthIntersectBounds(month, minDate, maxDate) {
...
export function clampCalendarMonthDate(month, preferredDay, minDate, maxDate) {
    assertCalendarDate(month);
