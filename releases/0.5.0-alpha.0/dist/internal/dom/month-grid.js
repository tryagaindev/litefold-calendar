...
export function createDayCellElements(options) {
...
function allowsSelectionMotion(document) {
    ...
    return matchMedia === undefined || (matchMedia.call(ownerWindow, SELECTION_MOTION_QUERY).matches &&
...
export function renderMonthWeeks(container, days, createDayCell, isCurrent, beforeCommit) {
    const weeks = [];
...
export function renderWeekdayHeadings(container, options) {
...
//# sourceMappingURL=month-grid.js.map