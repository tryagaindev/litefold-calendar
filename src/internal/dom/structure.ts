...
export interface CalendarDom extends CalendarMonthPickerElements {
	readonly agenda: HTMLElement;
	readonly agendaFooter: HTMLDivElement;
	readonly agendaList: HTMLOListElement;
	readonly agendaTitle: HTMLHeadingElement;
	readonly assertiveLive: HTMLParagraphElement;
	readonly grid: HTMLDivElement;
	readonly gridInstructions: HTMLParagraphElement;
	readonly monthStepper: HTMLDivElement;
	...
	readonly swipeViewport: HTMLDivElement;
	readonly todayButton: HTMLButtonElement;
	readonly toolbar: HTMLDivElement;
	readonly weekdays: HTMLDivElement;
