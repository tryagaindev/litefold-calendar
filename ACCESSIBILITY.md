...
6. **Responsive layout and visual preferences**
   ...
   - At representative supported phone widths and default text sizing, confirm the abbreviated month/year title stays on one line without horizontal overflow. For longer translations or enlarged text, confirm any visual ellipsis retains the complete accessible text.
